                                                         ...
                                                         tsZLO_ControlBridgeDevice     *psDeviceInfo )
{
    ...
    /* Optional CLient */
        ...
        // YB Add
      #if (defined CLD_ANALOG_INPUT_BASIC) && (defined ANALOG_INPUT_BASIC_CLIENT)
      /* create a instance of a ANALOG INPUT CLUSTER as a client */
         if(eCLD_AnalogInputBasicCreateAnalogInputBasic(&psDeviceInfo->sClusterInstance.sAnalogBasicCLIENT,
      	     	 	 	 	  FALSE,  /* client */
      	     	 	    	 &sCLD_AnalogInputBasic,/* cluster definition */
         ...
         // YB Add
          ...
          /* create a instance of a ANALOG INPUT CLUSTER as a server */
           if(eCLD_AnalogInputBasicCreateAnalogInputBasic(&psDeviceInfo->sClusterInstance.sAnalogBasicSERVER,
              	 	 	 	  TRUE,
							  &sCLD_AnalogInputBasic,/* cluster definition */
                              &psDeviceInfo->sAnalogInputServerCluster,
                             &au8AnalogInputBasicAttributeControlBits[0])!= E_ZCL_SUCCESS)
            {
               return E_ZCL_FAIL;
          }
