...
typedef struct
{
    ...
    /* YB add analog input */
    #if (defined CLD_ANALOG_INPUT_BASIC) && (defined ANALOG_INPUT_BASIC_CLIENT)
      tsCLD_AnalogInputBasic sAnalogInputClientCluster;
     #endif

    /* YB add analog input */
    #if (defined CLD_ANALOG_INPUT_BASIC) && (defined ANALOG_INPUT_BASIC_SERVER)
       tsCLD_AnalogInputBasic sAnalogInputServerCluster;
    #endif
